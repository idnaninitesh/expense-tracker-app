...
import com.codeitsuisse.team28.expensetracker.card.provider.LiableExpenseSummaryCardProvider;
 ...
 */
public class BasicLiableExpense extends android.support.v4.app.Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View row = inflater.inflate(R.layout.fragment_basic_liable_expense, container, false);
        ...
        title = "Liable Expense Summary";
        description = "Total Liable expenses : Rs."+db.sumPayLater(thisMonth,thisYear);

        mListView.add(getLiableExpenseSummaryCard(0));




        Expense[] arr=db.getAllPayLater(thisMonth, thisYear);
    ...
    private Card getLiableExpenseSummaryCard(int position) {

        final LiableExpenseSummaryCardProvider provider = new Card.Builder(MainActivity.a)
                .setTag("BASIC_IMAGE_BUTTON_CARD")
                .setDismissible()
                .withProvider(LiableExpenseSummaryCardProvider.class)
                .setTitle(title)
