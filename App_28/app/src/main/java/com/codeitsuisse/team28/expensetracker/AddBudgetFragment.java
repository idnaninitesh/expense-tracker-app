 ...
 * {@link AddBudgetFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AddBudgetFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AddBudgetFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        row = inflater.inflate(R.layout.fragment_add_budget,container,false);
        ...
        butt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(bug==null){
                    db.insertbudget(thisMonth,thisYear,amt);
                }else{
